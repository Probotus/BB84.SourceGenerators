...
public sealed class NotificationPropertiesGenerator : IIncrementalGenerator
{
	/// <inheritdoc/>
	private static readonly string GeneratorName = typeof(NotificationPropertiesGenerator).FullName;
